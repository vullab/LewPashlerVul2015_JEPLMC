function [E1_loc,E2_loc,E3free_loc,E3cued_loc,E3test_loc]=E3_locationAnalysis_color( ...
    E2_Mle,E1_Mle, ...
    E3trainFree_Mle,E3trainCued_Mle,E3test_Mle)
%% Use MLE to identify how many unique objects recalled in each experiment
% 4.17.2015-Created
% 11.25.2015-E3_locationAnalysis_color-Color version of figures
...
% E1
fill([-20:-1 fliplr(-20:-1)],[E1_mean+E1_sem fliplr(E1_mean-E1_sem)],.2+currCol(1,:),'LineStyle','none');
plot(-20:-1,E1_mean,'Color',.2+currCol(1,:)-.2)

% E2
fill([1 2 8 8 2 1],[E2_mean+E2_sem fliplr(E2_mean-E2_sem)],.2+currCol(1,:),'LineStyle','none');
plot([1 2 8],E2_mean,'Color',.2+currCol(1,:)-.2)

% E3
a=errorbar([1 2 8],testLoc_mean,testLoc_sem,'k','LineWidth',4,'Color',currCol(4,:));
errorbar(-20:-1,trainCuedLoc_mean(1:20),trainCuedLoc_sem(1:20),'k.','Color',currCol(1,:)-.2,'LineWidth',4,'Marker','o','MarkerSize',8);
b=plot([-100 -100],[-1 -1],'k-','Color',currCol(1,:)-.2,'LineWidth',4,'Marker','o','MarkerSize',8);
c=errorbar(-19:2:-1,trainFreeLoc_mean(1:10),trainFreeLoc_sem(1:10),'k.','LineWidth',4,'Color',currCol(4,:));
